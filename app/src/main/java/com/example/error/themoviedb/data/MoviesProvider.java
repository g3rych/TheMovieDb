...
public class MoviesProvider extends ContentProvider {
    ...
    public static final Uri MOVIE_PATH = Uri.withAppendedPath(Uri.parse(CONTENT_AUTHORITY),MoviesEntry.TABLE_NAME);
    public static final Uri TRAILER_PATH = Uri.withAppendedPath(Uri.parse(CONTENT_AUTHORITY),TrailersEntry.TABLE_NAME);
